...
/// PProg flat alignment of two MSAs via pair posteriors; returns the average expected accuracy
/// and writes the edit path to `path`.
#[track_caller]
pub fn p_prog_align_ms_as_flat(
    progress_str: &str,
    msa1: &MultiSequence,
    msa2: &MultiSequence,
